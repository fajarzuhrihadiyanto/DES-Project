exports.permute = function permute(source, permutation) {
    let result = ''
...
exports.string_to_binary = function string_to_binary(string) {
    let result = ''
...
exports.binary_to_string = function binary_to_string(binary) {
    let result = ''
...
exports.binary_to_hex = function binary_to_hex(binary) {
    let result = ''
...
exports.hex_to_binary = function hex_to_binary(hex) {
    let result = ''
...
exports.xor = function xor(string1, string2) {
    let result = ''
